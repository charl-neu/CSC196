...
namespace viper {
	namespace random {
		...
		/// <returns>A random integer greater than or equal to zero and less than max</returns>
		inline int getRandomInt(int max) { return rand() % max; }

		/// <summary>
		/// Generates a random integer in a specified inclusive range
		/// </summary>
		/// <param name="min">The lower bound of the range (inclusive)</param>
		/// <param name="max">The upper bound of the range (inclusive)</param>
		/// <returns>A random integet between min and max, inclusive</returns>
